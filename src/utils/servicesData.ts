...
export const servicesData: Record<string, ServiceDetail> = {
  ...
  "mosquito-safety-nets": {
    ...
    category: "safety-nets",
    categoryName: "Safety Nets",
    title: "Mosquito Safety Nets & Insect Mesh Installation in Andhra Pradesh | Pigeon Guard Solutions",
    description: "High-density fiberglass and SS304 fine mosquito mesh for windows, balconies, and doors across Andhra Pradesh. Keep mosquitoes out with unrestricted fresh airflow.",
    longDescription: "Pigeon Guard Solutions provides premium mosquito safety nets and fine insect screens custom-fabricated for high-rise apartment balconies, bedroom windows, French doors, and ventilation shafts across Andhra Pradesh. Manufactured with high-density fiberglass mesh or SS304 marine-grade micro-wire mesh, our mosquito netting creates an impenetrable barrier against mosquitoes, flies, bugs, and dengue vectors while maintaining 100% unrestricted airflow and natural daylight.",
    aiOverview: "Pigeon Guard Mosquito Safety Nets provide durable insect and mosquito exclusion using high-tensile fiberglass or SS304 stainless steel micro-mesh. Custom-fitted with magnetic, velcro, sliding, or openable aluminum frames, they shield homes from mosquito-borne diseases without restricting ventilation or scenic visibility.",
    image: "/images/main-images/Mosquito-Net.jpg",
    supportingImages: [],
    gallery: [],
    beforeImage: "",
    afterImage: "",
    benefits: ["100% Mosquito & Dengue Prevention", "High-Density Fiberglass / SS304 Micro-Mesh", "Unrestricted Natural Airflow & Light", "Custom Magnetic, Velcro & Sliding Frames", "Tear-Resistant & Washable Construction", "Free Doorstep Measurement Across Andhra Pradesh"],
    specsTable: [
      { label: "Mesh Material", value: "High-Grade Fiberglass / SS304 Micro Wire" },
      { label: "Mesh Density", value: "18 x 16 wires per sq. inch (Micro-Pore)" },
      { label: "Frame Options", value: "Extruded Aluminum / Magnetic Track / Velcro" },
      { label: "Durability", value: "5+ Years Weatherproof Lifespan" },
      { label: "UV Resistance", value: "High (UV-Stabilized Anti-Fray Coating)" },
      { label: "Rust Resistance", value: "100% Rustproof Stainless Steel / Powder-Coated Aluminum" },
      { label: "Maintenance", value: "Detachable & easily washable with water" },
    ],
    faqs: generateFAQsForService("Mosquito Safety Nets", "safety-nets"),
  },
  "anti-bird-spikes": {
    ...
    image: "/images/main-images/Bird-spikes-pigeon-guard.jpg",
    supportingImages: [],
    gallery: [],
    beforeImage: "",
    afterImage: "",
...
const imageOverrides: Record<string, string> = {
  ...
  "sports-nets": "/images/main-images/cricketpracticenet-Pigeon-Guard.jpg",
  "cricket-practice-nets": "/images/main-images/cricketpracticenet-Pigeon-Guard.jpg",
  "construction-safety-nets": "/images/hero/constructionnet.webp",
  "duct-area-safety-nets": "/images/hero/ductarea.webp",
  "monkey-safety-nets": "/images/main-images/Monkey-Safety-Nets-pigeonguard.jpg",
  "mosquito-safety-nets": "/images/main-images/Mosquito-Net.jpg",
  "anti-bird-spikes": "/images/main-images/Bird-spikes-pigeon-guard.jpg",
